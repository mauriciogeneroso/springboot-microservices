package com.generoso.microservices.auth.security.filter;
...
public class JwtUsernameAndPasswordAuthenticationFilter extends
  ...
  public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
    ...
    log.info("Creating the authentication object for the user '{}' and calling "
        + "UserDetailServiceImpl loadUserByUsername", applicationUser.getUsername());
